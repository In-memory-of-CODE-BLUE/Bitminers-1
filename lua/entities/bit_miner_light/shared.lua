...
function ENT:Initialize()
	...
	self:SetModel("models/BITMINER/BitMinerLight.mdl")
	...
	if(SERVER) then
		...
		self:EmitSound("bitminer_sound_light", 25, 100, 1, CHAN_AUTO )
